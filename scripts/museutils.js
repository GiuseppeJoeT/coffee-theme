...
(function(c) {
        ...
        for (var d = 0; d < a.childNodes.length; d++) {
            ...
            if (l.nodeType == 1) {
                if (!b || b.matches(l))
                    return l;
                if (!c || !c.matches(l))
                    if (l = Muse.Utils.firstDescendant(l, b, c))
                        return l
            }
        }
        return null
    ...
    Muse.Utils.descendants = function(a, b, c, d) {
        ...
        for (var l = 0; l < a.childNodes.length; l++) {
            ...
            j.nodeType == 1 && ((!b || b.matches(j)) && d.push(j),
            (!c || !c.matches(j)) && Muse.Utils.descendants(j, b, c, d))
        }
        return d
    }
    ;
    ...
    Muse.Utils.allStyleSheetRulesFromOneSheet = function(a, b) {
        ...
        for (var j = [], k = c(window), i = function(a) {
            ...
            c = b.replace(/\sand\s/g, "__and__").replace(/\s/g, "").split("__and__"),
            a && a.sort && c && c.sort)) {
            ...
            var n = g[m];
            if (i(n)) {
                if (n = Muse.Utils.allStyleSheetRulesFromOneSheet(n, b),
                null != n)
                    for (var q = 0; q < n.length; q++)
                        j.push(n[q])
            } else if (Muse.Utils.isDefined(n.selectorText))
                if (d)
                    b(n.selectorText) && j.push(n);
                else
                    for (var q = n.selectorText.split(/\s*,\s*/), p = 0; p < q.length; p++)
                        b(q[p]) && j.push(n)
        }
        ...
        if (!g || g == "_self") {
            ...
            if (j && g > l) {
                ...
                var g = i.offset()
                  ...
                  , j = (a ? a.scrollHeight() : l.scrollHeight) - d.height()
                  ...
                  , o = function() {
                    ...
                    a && a.length && !a.hasClass("AccordionPanelTabOpen") && (a.trigger("mousedown"),
                    a.trigger("mouseup"))
                };
                if (p) {
    ...
    Muse.Utils.addHyperlinkBlock = function(a) {
        ...
        b.bind("mouseup keyup", function(b) {
            Muse.Utils.isMouseLeftClick(b) && d.indexOf(this) != -1 ? b.ctrlKey || b.metaKey ? Muse.Utils.redirectHyperlinkInNewTab(a.href, b.shiftKey) : Muse.Utils.redirectHyperlink(a) : Muse.Utils.isMouseMiddleClick(b) && d.indexOf(this) != -1 ? Muse.Utils.redirectHyperlinkInNewTab(a.href, b.shiftKey) : Muse.Utils.isRedirectLinkKeyboardAction(b) && Muse.Utils.redirectHyperlink(a);
            return !1
        });
    ...
    Muse.Utils.enableAnchorLinksActiveState = function() {
        var a = !1
          ...
          , p = function() {
            ...
            var d = a ? n.scrollLeft() : n.scrollTop(), g;
            a: {
                var h = 0;
                g = b.length;
                for (var o; h < g; h++)
            ...
            for (g = Math.min(g + 2, b.length); h < g; h++)
                if (p = b[h],
                o = p.$elem.offset().left + (m && !m.isStandard() ? m.scrollLeft() : 0),
                t = p.$elem.offset().top + (m && !m.isStandard() ? m.scrollTop() : 0),
                p.from != (a ? o : t)) {
                    k(q);
                    break
                }
            ...
            for (g = b.length; h < g; h++) {
                ...
                for (var y = 0; y < p.length; y++)
                    t = l(p[y]),
                    o && !p[y].hasClass(t) ? p[y].addClass(t) : !o && p[y].hasClass(t) && p[y].removeClass(t)
            }
        }
          , o = function() {
            i || (i = !0,
            Muse.Utils.requestAnimationFrame(p))
        };
    ...
    Muse.Utils.saveHyperlinkInfo = function(a, b, d, g, l) {
        ...
        if (j && -1 != j.indexOf("#") && !(m && m != "_self") && !(0 <= k.indexOf("/")) && (n.charAt(n.length - 1) == "/" && (n += "index.html"),
    ...
    Muse.Utils.transformMarkupToFixBrowserProblemsPreInit = function() {
        ...
        b.browser.msie ? (b("html").addClass("ie"),
        b.browser.version < 8 && Muse.Utils.changeLItoDIVs(),
        b.browser.version < 9 && (Muse.Utils.monitorCheckboxes(),
        Muse.Utils.addRoundedCorners())) : b.browser.SafariMobile && b("body").css("-webkit-text-size-adjust", "none")
    }
    ;
    ...
    Muse.Utils.transformMarkupToFixBrowserProblems = function() {
        ...
        b.browser.msie && b.browser.version <= 9 && (b.browser.version <= 9 && (Muse.Utils.addGradientFill(),
        Muse.Utils.addShadows()),
        b.browser.version < 9 && (Muse.Utils.applyIEFilterToPNGImages(),
        Muse.Utils.addRGBA(),
        ...
        typeof window.matchMedia === "undefined" && typeof window.msMatchMedia === "undefined" && c("html").addClass("nomediaqueries");
            ...
            Muse.Utils.needPIE(function() {
                ...
                if (!b.data("mu-ie-matrix")) {
                    ...
                    if (!d || !(d.toLowerCase().indexOf("opacity") > 0 && d.indexOf("=100") < 0)) {
                        if (a.childNodes.length && !Muse.Browser.Features.checkCSSFeature("border-radius") && (d = Muse.Utils.firstChild(a, Muse.Utils.Match.byNodeName("img"))) && d.nodeName.toLowerCase() == "img") {
                            var d = c(d)
                              , g = d.attr("src")
                              , l = b.css("background-color") + " "
                              , j = d.css("margin-left");
                            if (j == "0px" || j == "auto")
                                j = d.css("padding-left");
                            var k = d.css("margin-top");
                            if (k == "0px" || k == "auto")
                                k = d.css("padding-top");
                            if ((j == "0px" || j == "auto") && (k == "0px" || k == "auto"))
    ...
    Muse.Utils.resizeHeight = function(a) {
        ...
        if (0 < c(".breakpoint").length)
            c("body").on("muse_bp_activate", function(g, l, j) {
                b = {};
                c(a, j).each(function() {
    ...
    Muse.Utils.moveElementsOutsideViewport = function(a) {
        ...
        a.each(function() {
            b = c(this);
            b.css("display") === "none" && (b.attr("data-margin-left", b.css("margin-left")),
            b.css("margin-left", Muse.Utils.marginLeftForMovingElementsOutSideViewPort),
            b.css("display", "block"),
    ...
    Muse.Utils.moveElementsInsideViewport = function(a) {
        ...
        a.each(function() {
            b = c(this);
            b.attr("data-display-attr-change") === "true" && (b.css("display", ""),
            b.css("display") != "none" && b.css("display", "none"),
            b.css("margin-left", ""),
            b.css("margin-left") != b.attr("data-margin-left") && b.css("margin-left", b.attr("data-margin-left")),
    ...
    Muse.Utils.adjustTargetAndSlideHeights = function(a, b) {
        ...
        b === "lightbox" ? a.css("height", l + "px") : a.css("height", a.outerHeight() + "px")
    }
    ;
        ...
        for (var d = 0; d < b.children().length; d++) {
            ...
            if (j != void 0) {
                ...
                case "page_fixedRight":
                    i = g.offset().left - (a.offset().left + a.width()),
                    m = a.offset().left + a.width() - l.parent().offset().left,
                    k = !0
                }
                k && Muse.Utils.isLeftInPercentForLightbox(l.parent()) && (j = m * 100 / l.parent().width(),
                l.css("margin-left", j + "%"),
                l.css("left", "0px"),
                g.css("left", i + "px"),
    ...
    Muse.Utils.isLeftInPercentForLightbox = function(a) {
        ...
        if (!b && a.hasClass("clearfix"))
            for (var d = 0; d < a.children().length; d++) {
                ...
                if (Muse.Utils.isLeftInPercentForLightbox(g))
                    return !0
            }
        return b
    }
    ...
    Muse.Utils.fullPage = function(a) {
        ...
        if (0 == c(a).closest(".breakpoint").length)
            Muse.Assert.assert(0 == c(".breakpoint").length, "Page is outside a breakpoint node."),
            b.init(c(a));
        else {
            var d = function(d) {
    ...
    Muse.Utils.widgetInsideLightbox = function(a) {
        for (var b = 0; b < a.length; b++)
            if (c(a[b]).attr("data-islightbox") == "true")
                return !0;
        return !1
    }
    ;
    ...
    Muse.Utils.detachIframesAndObjectsToPauseMedia = function(a) {
        ...
        c("iframe, object", a).each(function() {
            ...
            if (!a.is("object") || !(b.browser.msie && b.browser.version < 9)) {
                if (a.is("iframe")) {
                    ...
                    if ("" == l || !l || !l.indexOf)
                        return;
                    if (a.attr("title") === "recaptcha widget")
                        return;
                ...
                l.$next = a.next();
                l.$parent = a.parent();
                b.browser.msie ? (l.html = a.wrap('<div id="deleteMeWrapper"/>').parent().html(),
                a.remove(),
                l.$parent.children("div #deleteMeWrapper").remove()) : (l.$node = a.clone(),
                a.remove());
                d.push(l)
            }
        });
        ...
        c("video", a).each(function() {
            if (b.browser.msie && b.browser.version == 9 && this.pause && this.getAttribute("autoplay") && this.readyState != 4)
    ...
    Muse.Utils.setPageToMaxWidth = function() {
        var a = c("#page");
        a !== void 0 && a.css("max-width") !== "none" && (a.css("width", a.css("max-width")),
        c(window).trigger("pageWidthChanged"))
    }
    ;
    Muse.Utils.resetPageWidth = function() {
        var a = c("#page");
        a !== void 0 && (a.css("width", ""),
        c(window).trigger("pageWidthChanged"))
    }
    ;
    ...
    Muse.Utils.getMarginLeft = function(a) {
        if (a && !c.isEmptyObject(a))
            return a.attr("data-margin-left") && a.attr("data-display-attr-change") === !0 ? a.attr("data-margin-left") : window.getComputedStyle(a[0])["margin-left"]
    }
    ;
    Muse.Utils.classifyChildrens = function(a, b, d) {
        function g(a) {
            var c = a.attr("data-pintopage")
              ...
              , n = !0;
            Muse.Utils.isTopLevelWidget(a) || a.is("form") || Muse.Utils.isMenuWidget(a) || Muse.Utils.isParameterizedHtmlWidget(a) ? b.ChildWidgets.push(a) : (g > 0 || h > 0) && !Muse.Utils.isParameterizedHtmlWidget(a) ? b.ChildWithMinWidth.push(a) : c !== void 0 && d !== void 0 ? (Muse.Utils.dropInOneBucketOfSizeAndPinPolicy(c, d, b, a),
            Muse.Utils.removeSizeAndPiningAttributes(a)) : n = !1;
            return n
        }
    ...
    Muse.Utils.getPropInPixel = function(a, b) {
        var c;
        a && b && a.css("display") !== "none" && (c = b === "margin-left" ? Muse.Utils.getMarginLeft(a) : window.getComputedStyle(a[0]).getPropertyValue(b),
        Muse.Utils.isInPercentage(c) && (b === "left" ? (c = a.offsetParent().width() * parseFloat(c) / 100,
        c = c.toString() + "px") : b === "margin-left" ? (c = a.parent().width() * parseFloat(c) / 100,
        c = c.toString() + "px") : c = a.css(b)));
        return c
    }
    ;
    ...
    Muse.Utils.getOffsetWidth = function(a) {
        ...
        if (b === 0)
            b = Muse.Utils.getWidths(a).offsetWidth;
        return b
    }
    ;
    Muse.Utils.getChildWidth = function(a, b, c) {
        return b === !0 ? (b = parseFloat(a.css("min-width")) ? parseFloat(a.css("min-width")) : parseFloat(a.attr("data-min-width")),
        a.css("box-sizing") !== "border-box" && (b += Math.round(a.outerWidth() - a.innerWidth())),
        b) : c ? window.getComputedStyle(a[0]).width : Muse.Utils.getOffsetWidth(a)
    }
    ;
    Muse.Utils.setMinWidthInformation = function(a, b, d) {
        if (!c.isEmptyObject(a) && a.chosenMinWidth && a.$element && d > 0 && a.chosenMinWidth < d)
            a.$element = b,
            a.chosenMinWidth = d;
        return a
    }
    ...
    Muse.Utils.getLeft = function(a, b) {
        function c(a, d) {
            if (a && d)
                return b ? Muse.Utils.getPropInPixel(a, d) : d === "margin-left" ? Muse.Utils.getMarginLeft(a) : window.getComputedStyle(a[0]).getPropertyValue(d)
        }
        var d = {
            $element: a,
            left: c(a, "left")
        ...
        if (a.css("position") === "absolute") {
            var l = a.parent();
            if (l && l.hasClass("popup_anchor") && l.css("position") === "relative")
                d.$element = l,
                d.left = c(l, "left"),
                consultMarginLeft = !0
        }
        ...
        if (l !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort)
            if (d.$element.css("position") === "static" || d.left === "auto")
                d.left = l;
            else if ((d.left === "0px" || d.left === "0%") && l !== "auto")
                d.left = l;
        if ((d.$element.css("position") === "static" || d.left === "0px" || d.left === "0%" || d.left === "auto") && l !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort)
            d.left = l;
        return d
    }
    ;
    Muse.Utils.getLeftAdjustmentAmountDoneByParents = function(a, b) {
        ...
        c.each(d, function(a, d) {
            ...
            if (h[0] !== void 0 && b.closest(h).length) {
                var i = Muse.Utils.getMarginLeft(h);
                if (Muse.Utils.isInPixel(i))
                    g += parseFloat(i);
                else if (Muse.Utils.isInPercentage(i) || i === "auto")
                    Muse.Utils.moveElementsOutsideViewport(h),
                    Muse.Utils.moveElementsOutsideViewport(h.parents()),
                    i = Muse.Utils.getPropInPixel(h, "margin-left"),
                    Muse.Utils.isInPixel(i) && i !== Muse.Utils.marginLeftForMovingElementsOutSideViewPort && (g += parseFloat(i)),
        ...
        if (a && a.length > 0)
            ...
            case "page_fixedLeft":
                a.forEach(function(a) {
                    var b = Muse.Utils.getChildWidth(a, c, !0)
                      ...
                      , n = 0
                      , q = 0;
                    Muse.Utils.isInPercentage(b) ? (i = parseFloat(b) / 100,
                    b = Muse.Utils.getWidths(a),
                    q = b.elemWidth,
                    f = b.offsetWidth) : Muse.Utils.isInPixel(b) && (i = a.offsetParent().width(),
                    q = parseFloat(b),
                    i = i > 0 ? q / i : 0);
                    i > 0 && (f > Math.round(q) && (n = f - Math.round(q)),
                    b = Math.abs(Muse.Utils.isValueWithinTolerance(i, 1, 1.0E-4) ? a.outerWidth() : (m + n) / (1 - i)),
            ...
            case "page_fixedRight":
                a.forEach(function(a) {
                    ...
                    Muse.Utils.isInPercentage(b) ? f = parseFloat(b) / 100 : Muse.Utils.isInPixel(b) && (f = a.offsetParent().width(),
                    b = parseFloat(b),
                    f = f > 0 ? b / f : 0);
                    if (f > 0 && f < 1 && !Muse.Utils.isValueWithinTolerance(f, 1, 1.0E-4))
                        var m = Math.abs(i / (1 - f));
            ...
            case "page_fixedCenter":
                a.forEach(function(a) {
                    var b = window.getComputedStyle(a[0]).left
                      ...
                      , o = 0;
                    if (b !== 0)
                        Muse.Utils.isInPercentage(i) ? m = parseFloat(i) / 100 : Muse.Utils.isInPixel(i) && (m = a.parent().width(),
                        i = parseFloat(i),
                        m = m > 0 ? i / m : 0),
                        Muse.Utils.isInPercentage(n) ? (n = Muse.Utils.getWidths(a),
                        o = n.elemWidth,
                        q = n.offsetWidth) : Muse.Utils.isInPixel(n) && (o = parseFloat(n)),
                        m > 0 && (b > 0 && q > Math.round(o) && (p = q - Math.round(o)),
                        Muse.Utils.setMinWidthInformation(d, a, Math.abs((f + p) / m)))
                })
            }
        return d
    }
            ...
            case "page_fixedCenter":
                a.forEach(function(a) {
                    var b = Muse.Utils.getChildWidth(a, d, !1)
                      ...
                      , p = 0
                      , o = -1;
                    Muse.Utils.isInPercentage(f) ? p = parseFloat(f) / 100 : Muse.Utils.isInPixel(f) && (p = a.parent().width(),
                    f = parseFloat(f),
                    p = p > 0 ? f / p : 0);
                    p > 0 && (o = Muse.Utils.getLeftAdjustmentAmountDoneByParents(a, g),
                    o = o < 0 ? 0 : o,
                    f = (Math.abs(c) - o) / p,
                    c < 0 ? c += o : c > 0 && (c -= o),
                    Muse.Utils.isValueWithinTolerance(p, 1, 1.0E-4) || (l = (b + c) / (1 - p)),
                    o = Math.max(f, l, b),
                    Muse.Utils.setMinWidthInformation(j, a, o > b ? o : b))
                })
            }
        return j
    }
    ...
    Muse.Utils.computeMinWidthForChildsWithMinWidth = function(a, b) {
        ...
        a.forEach(function(a) {
            ...
            d !== void 0 && (j = Muse.Utils.computeMinWidthForFixedChilds([a], d, !0, b),
            Muse.Utils.setMinWidthInformation(c, a, j.chosenMinWidth))
        });
        return c
    }
    ;
    ...
    Muse.Utils.computeMinWidthForForms = function(a) {
        ...
        d.forEach(function(b) {
            ...
            c.each(d, function(b, d) {
                ...
                if (k = parseFloat(h.attr("data-min-width")))
                    j.chosenMinWidth = Math.max(j.chosenMinWidth, k);
        ...
        l > 0 && (a.css("min-width", l),
        a.removeAttr("data-min-width"))
    }
    ;
    Muse.Utils.computeMinWidthForWidgetChilds = function(a, b) {
        ...
        a.forEach(function(a) {
            ...
            if (!a.hasClass("SlideShowWidget") && !a.hasClass("PamphletWidget") && Muse.Utils.isElementFixedSize(a))
                b = (b = window.getComputedStyle(a[0]).width) ? parseFloat(b) : 0,
                a.attr("data-min-width", b);
            else if (a.is("form"))
                Muse.Utils.computeMinWidthForForms(a);
            else {
                var c;
                ...
                c && c._setMinWidth && (c._setMinWidth(a, !0),
        ...
        d.forEach(function(a) {
            ...
            h.$element && !c.isEmptyObject(h.$element) && h.$element.attr("data-min-width") && (h.$element.removeAttr("data-min-width"),
    ...
    Muse.Utils.adjustMinWidthRespectToAllParents = function(a, b) {
        ...
        b.forEach(function(b) {
            if (b && !c.isEmptyObject(b) && b.$element && !c.isEmptyObject(b.$element) && b.chosenMinWidth > 0) {
                if (!a.is(b.$element)) {
    ...
    Muse.Utils.getMinWidthOfParts = function(a, b, d) {
        ...
        function j(a) {
            if (b.attr("data-contentlayout") === "stack" && (b.attr("data-transitionStyle") === "horizontal" || b.attr("data-transitionStyle") === "vertical"))
                return a = a.attr("data-pintopage"),
                a === "page_fixedRight" || a === "page_fixedCenter";
            return !1
        }
        var k = -1;
        if (a && b && !c.isEmptyObject(a) && !c.isEmptyObject(b) && b[0] && a[0]) {
            ...
            var q = !1
              ...
              , r = g(a)
              , s = l(a)
              , v = a.outerWidth() - a.innerWidth();
            if (j(a))
                return k;
            n > 0 && (i = "fixed",
            r = n + v,
            q = !0,
            m === void 0 && (m = "page_fluidx"));
            if (i === "fixed")
                switch (m) {
                case "page_fluidx":
                    i = -1;
                    o.left <= s.left ? (o = s.left - o.left,
                    o >= 0 && (i = o / p)) : s.left - o.left < 2 && (i = 0);
                    i >= 0 && (Muse.Utils.isValueWithinTolerance(i, 1, 1.0E-4) ? k = 0 : i < 1 && (k = r / (1 - i)));
                    break;
                case "page_fixedLeft":
                    q || (p = -1,
                    o.left <= s.left ? p = s.left - o.left : s.left - o.left < 2 && (p = 0),
                    p >= 0 && (k = r + p));
                    break;
                case "page_fixedRight":
                    q || (p = -1,
                    o.right >= s.right ? p = o.right - s.right : o.right - s.right < 2 && (p = 0),
                    p >= 0 && (k = r + p));
                    break;
                case "page_fixedCenter":
                    q || (p <= r ? k = r : s.left <= o.left || s.right >= o.right ? (p = o.left - s.left,
                    i = s.right - o.right,
                    p >= 0 && i <= 0 ? k = r + (o.right - s.right) : i >= 0 && p <= 0 && (k = r + (s.left - o.left))) : (s = s.left + r / 2,
                    o = o.left + p / 2,
                    p = -1,
                    p = s === o ? 0 : s < o ? o - s : s - o,
                    p >= 0 && (k = 2 * (r / 2 + p))))
    ...
    Muse.Utils.getMinWidthForElement = function(a, b) {
        ...
        if (a && a.length > 0 && a[0].style.minWidth === "" || b) {
            if (Muse.Utils.isElementFixedSize(a) && !b)
                return c;
            var d = {
                responsive: {},
                fixed: {}
            ...
            l.push(Muse.Utils.computeMinWidthForFixedChilds(d.fixed.ChildFixedLeft, "page_fixedLeft", !1, a));
    ...
    Muse.Utils.buttonsMinWidthHelper = function() {
        ...
        c(".Button").each(function() {
            var a = c(this)
              , b = 0;
            !Muse.Utils.isElementFixedSize(a) && b === 0 && (b = Muse.Utils.getMinWidthForElement(a, !1),
            b > 0 && a.css("min-width", b));
            a.attr("data-visibility") === "changed" && (a.css("visibility", ""),
            a.removeAttr("data-visibility"))
        });
    ...
    Muse.Utils.VimeoVideoHelper = function(a) {
        var b = []
          ...
          , j = function(a) {
            ...
            if (c) {
                ...
                for (j = 0; j < b.length; )
                    g = b[j],
                    g.source == a.source && g.method == c.method ? (g.callbackFn(c.value),
                    b.splice(j, 1)) : j++
            }
        };
        ...
        ;
        j.prototype.isPaused = function(a, b) {
            c(a, function() {
                d(a, "paused", null, b)
            })
        }
    ...
    (function(a) {
        ...
        j.swapSources = function(a, b, c) {
            var d = a.attr("data-" + b);
            d && !("src" == b && a.hasClass("ImageInclude") && a.attr("src").indexOf("images/blank.gif") == a.attr("src").length - 16 && a.parents(".SlideShowWidget").length) && ("src" == c && !a.attr("data-" + c) && a.attr("data-" + c, a.attr("src")),
            a.attr("src", d))
        }
        ;
        j.isRetina = function() {
        ...
        j.prototype.setCurrentMode = function(a) {
            ...
            if (j.isRetina) {
                ...
                j.shouldUseCookie && j.saveResolutionPreference(a)
            }
        }
        ;
    ...
    Muse.Browser.Features.checkCSSValueCompatibility = function(a, b) {
        ...
        for (var l = 0; l < Muse.Browser.domPrefixes.length; l++) {
            ...
            c.style[a] = j;
            if (c.style[a] !== d)
                return Muse.Browser.domPrefixes[l]
        }
        return !1
    }
    ;
    ...
    (function(a) {
        ...
        d.prototype.init = function(d) {
            ...
            if (0 != this.$verticalSpacer.length) {
                ...
                this.pageMinHeight = Muse.Utils.getCSSIntValue(d, "padding-top") + Muse.Utils.getCSSIntValue(d, "min-height") + Muse.Utils.getCSSIntValue(d, "padding-bottom");
                ...
                b.resize(function() {
                    if (k) {
                        var a = b.width();
                        l ? (j.splice(0, j.length),
                        j.push(a),
                        l = !1,
                        setTimeout(function() {
                            l = !0
                        }, 200)) : j[j.length - 1] != a && (j.push(a),
                        3 < j.length && j[j.length - 3] == j[j.length - 1] && (c.addClass("always_vert_scroll"),
                        k = !1))
                    }
                    i.doUpdate()
                });
        ...
        d.prototype.doUpdate = function() {
            if (this.enabled && 0 != this.$verticalSpacer.length) {
                ...
                d = (g ? d + this.minHeight : Muse.Utils.getCSSIntValue(this.$verticalSpacer, "min-height")) < this.$verticalSpacer.height();
                g = !1;
                d && !c.hasClass("no_vert_scroll") ? (c.addClass("no_vert_scroll"),
                g = !0,
                a(window).trigger("resize")) : !d && c.hasClass("no_vert_scroll") && (c.removeClass("no_vert_scroll"),
                g = !0);
        ...
        l.prototype.updateScrollClass = function(a) {
            if (!this.alwaysVertScroll) {
                var a = this.spacerMinHeight < Math.floor(a * 100) / 100
                  , b = !1;
                a && !c.hasClass("no_vert_scroll") ? (c.addClass("no_vert_scroll"),
        ...
        ;
        l.prototype.doUpdate = function(a) {
            if (this.enabled)
                if (this.initialized) {
                    parseInt(a) || (a = 0);
        ...
        0 < k && 0 < i && 300 == i - k ? (j.remove(),
        j = new d) : (a("html").removeClass("css_verticalspacer"),
        j = new l);
    ...
    Muse.Utils.animationFrameFx = function(a) {
        var b = a.fx;
        a.extend(b, a.fx);
        var c, d = a(window).data("stickyFooter"), l = function() {
            c && (Muse.Utils.requestAnimationFrame(l),
            b.tick(),
            d.doUpdate())
        };
        b.timer = function(b) {
            b() && a.timers.push(b) && !c && (c = !0,
            l())
        }
        ;
        b.stop = function() {
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2017.1.0.379" != d.getAttribute("content") && Muse.assets.outOfDate.push("museutils.js");
                    break
                }
            }
        }
