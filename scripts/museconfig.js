    ...
    if (!window.museConfigLoadedAndExecuted) {
        ...
        var d = {
            ...
            paths: {
                ...
                "jquery.museoverlay": "scripts/jquery.museoverlay.js?crc=255055991",
                ...
                "museutils": "scripts/museutils.js?crc=420836567",
                "musewpdisclosure": "scripts/musewpdisclosure.js?crc=403040780",
                "musewpslideshow": "scripts/musewpslideshow.js?crc=4267795568",
                ...
                "webpro": "scripts/webpro.js?crc=57448180",
        ...
        define("jquery-private", ["jquery"], function(b) {
            b = b.noConflict(!0);
            if ("undefined" === typeof $)
                window.$ = window.jQuery = b;
            return b
        });
        if (true && document.location.protocol != "https:")
            d.paths.jquery = ["http://musecdn2.businesscatalyst.com/scripts/4.0/jquery-1.8.3.min", d.paths.jquery];
        requirejs.config(d);
        muse_init()
    }
}
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2017.1.0.379" != d.getAttribute("content") && Muse.assets.outOfDate.push("museconfig.js");
                    break
                }
            }
        }
