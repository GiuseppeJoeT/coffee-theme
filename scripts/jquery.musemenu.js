...
(function(d) {
    ...
    d.fn.museMenu = function() {
        return this.each(function() {
            var b = this.id, c = d(this), a = c.closest(".breakpoint"), g = "absolute", j, f, h, i, l, k;
            if (!c.data("initialized")) {
                ...
                var m = function(a) {
                        ...
                        for (a = c.parent(); !a.is(document) && a.length > 0 && a.attr("id") != "page"; ) {
                            if (a.css("position") == "fixed") {
                                ...
                                var d = a.offset()
                                  ...
                                  , o = n ? Muse.Utils.getRuleProperty(n, "top") : a.css("top")
                                ...
                                l = parseInt(a.css("margin-left")) + (p && p.indexOf("%") != -1 ? m.left - d.left : 0);
                                break
                            }
                            a = a.parent()
                        }
                  ...
                  , p = function(b, c) {
                    a.is(b) && s.each(function() {
                        ...
                        a && (c.swapPlaceholderNodesRecursively(a),
                        c.activateIDs(a))
                    })
                };
                ...
                n();
                var o = d(), q = !1, r = c.find(".MenuItemContainer"), s = c.find(".MenuItem"), w = c.find(".SubMenu").add(s), x;
                ...
                s.each(function() {
                    var a = d(this), b = a.siblings(".SubMenu"), n = a.closest(".MenuItemContainer"), p = n.parentsUntil(".MenuBar").filter(".MenuItemContainer").length === 0, q;
                    if (p && b.length > 0)
                        a.data("offsetContainerRaw", d("<div style='position:" + g + "' class='MenuBar popup_element'></div>").hide().appendTo("body")),
                        b.show(),
                        q = b.position().top,
                        b.hide();
                    var s = function(a) {
                    ...
                    b.length && (a.attr("aria-haspopup", !0),
                    Muse.Browser.Features.Touch && (a.click(function() {
                        return b.is(":visible")
                    }),
                    d(document.documentElement).on(Muse.Browser.Features.Touch.End, Muse.Browser.Features.Touch.Listener(function(c) {
                        !b.is(":visible") && d(c.target).closest(n).length > 0 ? (c.stopPropagation(),
                        Muse.Utils.redirectCancelled = !0,
                        setTimeout(function() {
                            Muse.Utils.redirectCancelled = !1
                        }, 16),
                        a.data("mouseEntered") && setTimeout(function() {
                ...
                s.filter(".MuseMenuActive").each(function() {
                    for (var a = d(this).closest(".MenuItemContainer").data("$parentMenuItemContainer"); a && a.length > 0; )
                        a.children(".MenuItem").addClass("MuseMenuActive"),
        ...
        if (-1 != a) {
            ...
            for (var a = document.getElementsByTagName("meta"), b = 0, c = a.length; b < c; b++) {
                ...
                if ("generator" == d.getAttribute("name")) {
                    "2017.1.0.379" != d.getAttribute("content") && Muse.assets.outOfDate.push("jquery.musemenu.js");
                    break
                }
            }
        }
